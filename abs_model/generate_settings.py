...
# average times in ms
avg_times = [135,1400,130,199 + 528 + 147,33500]
...
scaling_in = [ 1000* x for x in [1000,6,1000,1000,100]]
scaling_in = [max(x,1000.0) for x in scaling_in]

# x scale out factor in ms
scaling_out = [ 1000* x for x in [999,4,999,999,65]]
...
scale_out_amount_list = [0,1,0,0,1]
